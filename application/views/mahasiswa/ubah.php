  ...
  <form name="form" id="form" role="form" method="post" action="<?php echo base_url('universal/' . "aksi_ubah/" . $modul); ?>">
    ...
    <div class="form-group">
      <label for="nim">NIM</label>
          <input value="<?php echo $data[$modul]->nim; ?>" required type="text" class="form-control" id="nim" placeholder="Isi NIM" name="data[nim]">          
    </div>

    <div class="form-group">
      <label for="nama">Nama</label>
          <input value="<?php echo $data[$modul]->nama; ?>" required type="text" class="form-control" id="nama" placeholder="Isi Nama" name="data[nama]">          
    </div>
